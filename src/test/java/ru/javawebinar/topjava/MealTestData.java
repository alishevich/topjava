...
public class MealTestData {
    ...
    public static final LocalDateTime START_DATE_TIME = of(2020, Month.JANUARY, 30, 12, 0);
    public static final LocalDateTime END_DATE_TIME = of(2020, Month.JANUARY, 30, 23, 0);
